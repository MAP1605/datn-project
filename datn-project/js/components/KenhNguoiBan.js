document.addEventListener("DOMContentLoaded", function () {
  ...
  // KHU VỰC: Điều hướng sidebar → hiện các phần: đơn hàng, sản phẩm, doanh thu, ví
    const sections = {
  ...
  // phần này dùng để ẩn phần đang hiển thị 
    function hideAll() {
  ...
  // CHỨC NĂNG: Hiện danh sách tất cả đơn hàng
  ...
  // CHỨC NĂNG: Hiện danh sách tất cả sản phẩm
  ...
  // CHỨC NĂNG: Hiện form thêm sản phẩm mới
  ...
  // CHỨC NĂNG: Hiện phần thống kê doanh thu
  ...
  // CHỨC NĂNG: Hiện ví người bán (giao dịch, số dư, rút tiền)
  ...
  // 🔍 CHỨC NĂNG: Tìm kiếm sản phẩm trong danh sách
  ...
  // CHỨC NĂNG: Nhấn 'Thêm mới' trong tabs → scroll đến form thêm
  ...
  // CHỨC NĂNG: Xoá sản phẩm (click icon 🗑 trong bảng)
  ...
  // CHỨC NĂNG: Tabs lọc doanh thu (Chưa/Đã thanh toán)
  ...
  // TÍNH TOÁN: Tổng tiền chưa thanh toán trong doanh thu
  ...
  // TÍNH TOÁN: Tổng tiền chưa thanh toán và đã thanh toán tuần này
  ...
  // CHỨC NĂNG: Xử lý ảnh sản phẩm và ảnh bìa khi thêm sản phẩm
  ...
  // MODAL: Hiển thị chi tiết sản phẩm khi click vào hàng
  ...
  // MODAL: Hiển thị chi tiết đơn hàng khi click 'Chi tiết'
  ...
  // CHỨC NĂNG: Xử lý thêm sản phẩm từ form vào bảng
  ...
  // CHỨC NĂNG: Modal rút tiền từ ví người bán
