                    ...
                    <div class="modal-content">
                      ...
                      <div class="order-detail-products">
                        <div class="order-product-row">
                          <div class="order-product-img"><img src="../assets/images/CuongDao__Logo-PEARNK.png" alt="Hình ảnh" width="50px"></div>
                      ...
                      <div id="order-section" class="order-table-container">  
                        ...
                        <table class="order-table" cellspacing="0" cellpadding="5">
                          ...
                          <tbody id="order-list">
                            <tbody id="order-list">
                              <tr data-status="Chờ xác nhận">
                                <td data-label="Chọn"><input type="checkbox" class="order-checkbox" /></td>
                                <td data-label="Mã đơn hàng">#0123456789</td>
                                <td data-label="Trạng thái">Chờ xác nhận</td>
                                <td data-label="Thời gian đặt hàng">20:30 14/11/2024</td>
                  ...
                  <table class="product-table">
                    ...
                    <tbody  id="product-list">
                      <tr class="product-row" data-status="Đang bán">
                        ...
                        <td class="btn-chi-tiet-san-pham"><img src="../assets/images/logo/CuongDao__Logo-PEARNK.png" alt="hình ảnh " class="product-list_img" width="80px"></td>
                      ...
                      <tr class="product-row" data-status="Ăn gậy">
                        <td><input type="checkbox" class="product-checkbox"></td>
                        <td class="btn-chi-tiet-san-pham"><img src="../assets/images/logo/CuongDao__Logo-PEARNK.png" class="product-list_img" alt="Hình ảnh" width="80px"></td>
